...
<div style="background-color: #f44336; padding: 10px; border-radius: 10px">
    <h1 style="color: white; text-align: center;">Welcome To SLA Cost Analysis Dashboard</h1>
</div>
"""
...
# Custom footer
footer_html = """
<div style="background-color: #f44336; padding: 10px; border-radius: 10px; margin-top: 20px;">
    <p style="color: white; text-align: center;">&copy; 2024 SLA Cost Analysis Dashboard. All rights reserved.</p>
</div>
"""
